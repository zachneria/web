      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        ...
        >
          {sold > 0 ? (
            ...
            >
              {soldShare >= 0.16 ? (
                <span style={{ color: "#161616", fontSize: 12, fontWeight: 800 }}>{sold}</span>
              ) : null}
            </div>
          ) : null}
          {remaining > 0 ? (
        ...
        <span style={{ width: 44, textAlign: "right", fontSize: 14, fontWeight: 800, color: "#161616" }}>
          {pct}%
        </span>
      </div>
...
export default async function DashboardEvents() {
  ...
  return (
    <div className="dsh-content-row">
      ...
      <h1 style={{ fontSize: 26, fontWeight: 800, margin: "0 0 4px", color: "#161616" }}>
        Create event
      </h1>
      ...
      <h2 style={{ fontSize: 20, fontWeight: 800, margin: "0 0 4px", color: "#161616" }}>
        Your events
      </h2>
...
const methodLabel: React.CSSProperties = { fontSize: 15, fontWeight: 700, color: "#161616" };

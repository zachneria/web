                  ...
                  <div style={styles.chips}>
                    {opts.map((o, i) => {
                      ...
                      return (
                        ...
                        >
                          {o.label ? (
                            <span style={{ ...styles.chipLabel, ...(sel ? styles.chipLabelSel : {}) }}>{o.label}</span>
                          ) : null}
                          <span style={{ ...styles.chipPrice, ...(sel ? styles.chipPriceSel : {}) }}>${o.price.toFixed(0)}</span>
                        </button>
                      );
                    })}
                  </div>
...
const styles: Record<string, CSSProperties> = {
  ...
  tName: { fontSize: 16, fontWeight: 700, color: "#F2F2F2" },
  tPrice: { fontSize: 14, color: "#9A9A9A", marginTop: 2 },
  feeNote: { color: "#999" },
  lowStockNote: { fontSize: 13, fontWeight: 700, color: "#FFB454", marginTop: 6 },
  soldOutNote: { fontSize: 13, fontWeight: 700, color: "#FF6B61", marginTop: 6 },
  ...
  // Teal = the "selected" color language (matches the app's choose-a-price chips).
  chipSel: { background: "#0FA7B5", borderColor: "#0FA7B5" },
  chipLabel: { fontSize: 12, fontWeight: 600, color: "#B8B8B8" },
  chipLabelSel: { color: "#FFFFFF" },
  chipPrice: { fontSize: 17, fontWeight: 800, color: "#F2F2F2" },
  chipPriceSel: { color: "#FFFFFF" },
  stepBtn: {
    width: 36,
    height: 36,
    borderRadius: 18,
  ...
  totRow: { display: "flex", justifyContent: "space-between", color: "#9A9A9A", fontSize: 14 },
  totRowBold: {
    display: "flex",
    justifyContent: "space-between",
    fontWeight: 800,
  ...
  codeAppliedText: { fontSize: 14, fontWeight: 700, color: "#34C759" },
  codeRemove: {
    background: "none",
    border: "none",
    color: "#9A9A9A",
  ...
  youreIn: { fontSize: 13, fontWeight: 700, letterSpacing: 1, color: "#34C759" },
  ticketCard: {
    background: "#1E1E1E",
    borderRadius: 16,
    padding: 24,
  ...
  hint: { fontSize: 11, fontWeight: 700, letterSpacing: 1, color: "#161616" },
